...
```
##   steps       date        interval
## 1    NA 2012-10-01  2012-10-01 0:0
## 2    NA 2012-10-01  2012-10-01 0:5
## 3    NA 2012-10-01 2012-10-01 0:10
## 4    NA 2012-10-01 2012-10-01 0:15
## 5    NA 2012-10-01 2012-10-01 0:20
## 6    NA 2012-10-01 2012-10-01 0:25
```
...
```r
#activity$averageSteps <- meanStepsPerDay
#plot(x = activity$interval,y = activity$averageSteps,type="l")
```
